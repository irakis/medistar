...
const Offer = () => {
    return(
        <div className={clsx(styles.offer, " d-flex flex-column align-items-center p-4")}>
            <h2>Oferta</h2>
            <p>
            ZOL „Tomaszowice” jest zakładem udzielającym całodobowych świadczeń zdrowotnych, które obejmują
            ...
            ZOL „Tomaszowice” udziela świadczeń zdrowotnych osobom ubezpieczonym oraz innym
            ...
            finansowanych ze środków publicznych.</p>
            <p><b>Obiekt jest monitorowany całodobowo. Wysokość comiesięcznej opłaty za pobyt w ZOL naliczana jest zgodnie z Art. 18, pkt. 1 Ustawy z dnia 27 sierpnia 2004 o świadczeniach opieki zdrowotnej finansowanej ze środków publicznych.</b></p>
            <p>
